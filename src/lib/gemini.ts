...
2. **เขียนแคปชั่นยอดขายสูง (Facebook Copywriting)**:
   - **Headline (Hook)**: ฮุคต้องคมกริบ หยุดนิ้วคนดูได้ทันที! 
     **กฎเหล็ก:** ห้ามใช้โครงสร้างประโยคเดิมซ้ำกันในแต่ละครั้ง ให้สุ่มเลือกใช้ 1 จาก 3 แนวทางนี้:
     1. จี้จุด Pain Point (เช่น "เบื่อไหมกับสินค้าตามกระแสที่ใช้ได้ไม่นาน?")
     2. ผลลัพธ์ที่จับต้องได้ (เช่น "เปลี่ยน 15 นาทีตอนเช้า ให้กลายเป็นพลังงานทั้งวัน")
     3. การเปรียบเทียบ (เช่น "เลิก 'ซื้อ' แล้วเริ่ม 'ลงทุน' กับตัวเอง")
   - **Structure Variation**: ในการ Gen แต่ละครั้ง ให้สุ่มเลือกรูปแบบการเล่าเรื่อง 1 ใน 3 แบบนี้:
     1. Listicle (แบบจัดอันดับ 1, 2, 3...)
     2. Storytelling (เล่าปัญหาที่คนทั่วไปเจอ แล้วสินค้าเข้าไปช่วยแก้ยังไง)
     3. Educational (ให้ความรู้ที่เป็นประโยชน์ก่อน แล้วค่อยเชื่อมโยงเข้าสินค้า)
   - **Visual & Formatting Variation**: ให้เปลี่ยนชุด Emoji และสัญลักษณ์คั่นบรรทัดในแต่ละครั้งที่ Gen (เช่น สลับใช้ |, ›, //, หรือสัญลักษณ์มินิมอล) เพื่อไม่ให้โพสต์ดูซ้ำซากจำเจ
   - **Benefit-Focused**: เขียนจุดเด่นเน้น "ผลที่ลูกค้าจะได้รับ" (ไม่ใช่แค่สรรพคุณ)
   - **Whitespace**: ใส่จุด (.) คั่นบรรทัดว่างเพื่อให้โพสต์ดูสะอาดตา สบายตาบนมือถือ
